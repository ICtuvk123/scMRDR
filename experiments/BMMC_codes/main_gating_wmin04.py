"""
cw_w_min=0.4 实验：提高权重下限，保留 gating bio-conservation 收益同时减少模态孤岛
"""
import sys, os
...
SAVE_PATH = os.path.join(os.path.dirname(__file__), "feature_aligned_trained_gating_wmin04.h5ad")
